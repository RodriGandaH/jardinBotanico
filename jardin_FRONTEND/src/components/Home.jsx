...
function Home() {
    ...
    return (
        <>
            <h2 style={{color: "#091f14"}}>Jardín Botánico Martín Cárdenas</h2>
            ...
            <h4 className='mt-2' style={{color: "#091f14"}}>Historia</h4>
            <div>
            ...
            <div className='mt-3 border-top'>
                <h4 className="mt-2" style={{color: "#091f14"}}>Visión</h4>
            ...
            <div className='mt-3 border-top'>
                <h4 className="mt-2" style={{color: "#091f14"}}>Misión</h4>
            ...
            <h4 className='mt-2 border-top pt-2' style={{color: "#091f14"}}>Galería de fotos</h4>
            <div className="d-flex justify-content-center">
            ...
            <h4 className='mt-2 pt-2 border-top' style={{color: "#091f14"}}>Visítanos</h4>
